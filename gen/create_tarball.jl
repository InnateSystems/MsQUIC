...
function create_msquic_artifact()
    ...
    cp("/Users/arhik/.julia/dev/MsQUIC/vcpkg/installed/arm64-osx/lib/libmsquic.dylib", 
       joinpath(lib_dir, "libmsquic.dylib"))
    
    # Create tarball
    tar_file = "/Users/arhik/.julia/dev/MsQUIC/artifacts/msquic.v2.4.8.aarch64-apple-darwin.tar.gz"
